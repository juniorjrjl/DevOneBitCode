...
export default {
    ...
    created(){
        ...
        .then(response => this.hobbies = response.body.resource, 
        response => M.toast({ html: "Ocorreu um erro ao carregar os Hobbies", classes: "red" }))
    },
    ...
    methods: {
        submit() {
            ...
            .then(response => this.hobbies.push(response.body.resource)
